...
describe('Update 7.0.0', function () {
    var initialTree;
    var schematicRunner;
    beforeEach(function () {
    ...
    it('should update codeylzer', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    devDependencies = JSON.parse(result.readContent('package.json'))
                        .devDependencies;
    ...
    it('should update ng-packagr dependencies', function () { return __awaiter(_this, void 0, void 0, function () {
        var result, devDependencies;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, schematicRunner
                        .callRule(ast_utils_1.updateJsonInTree('package.json', function (json) {
                        json.devDependencies = __assign({}, json.devDependencies, { 'ng-packagr': '^3.0.0' });
                        return json;
                    }), initialTree)
                        .toPromise()];
                case 1:
