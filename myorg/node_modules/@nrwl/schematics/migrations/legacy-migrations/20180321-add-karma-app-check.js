...
exports.default = {
    ...
    run: function () { return __awaiter(_this, void 0, void 0, function () {
        var contents, sourceFile, nodes, isPresent, snippet, karmaComment, res;
        return __generator(this, function (_a) {
            contents = fs.readFileSync('karma.conf.js').toString();
            sourceFile = ts.createSourceFile('karma.conf.js', contents, ts.ScriptTarget.Latest);
            nodes = ast_utils_1.getSourceNodes(sourceFile);
            isPresent = nodes
                .filter(ts.isCallExpression)
                .filter(function (callExpr) {
                return ts.isIdentifier(callExpr.expression);
            })
                .some(function (callExpr) {
