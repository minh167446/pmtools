...
describe('Update 7.5.0', function () {
    var initialTree;
    var schematicRunner;
    beforeEach(function () {
    ...
    it('should update typescript', function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    expect(ast_utils_1.readJsonInTree(result, 'package.json').devDependencies.typescript).toEqual('~3.2.2');
                    return [2 /*return*/];
            }
        });
    }); });
