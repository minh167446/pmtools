...
export declare const angularSchematicNames: string[];
export declare function getWorkspacePath(host: Tree): string;
export declare function getNpmScope(host: Tree): string;
...
export declare function replaceAppNameWithPath(node: any, appName: string, root: string): any;
