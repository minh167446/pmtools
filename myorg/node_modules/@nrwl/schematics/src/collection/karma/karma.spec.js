...
describe('karma', function () {
    ...
    it('should generate files', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_utils_1.runSchematic('karma', {}, appTree)];
                case 1:
                    resultTree = _a.sent();
    ...
    it('should add dependencies', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(packageJson.devDependencies['karma-coverage-istanbul-reporter']).toBeDefined();
