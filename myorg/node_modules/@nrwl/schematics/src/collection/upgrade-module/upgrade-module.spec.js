...
describe('upgrade-module', function () {
    ...
    it('should update the bootstrap logic', function () { return __awaiter(_this, void 0, void 0, function () {
        var tree, appModule, legacySetup;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_utils_1.runSchematic('upgrade-module', {
                        name: 'legacy',
                        project: 'myapp'
                    }, appTree)];
                case 1:
                    ...
                    legacySetup = test_1.getFileContent(tree, '/apps/myapp/src/legacy-setup.ts');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, testing_utils_1.runSchematic('upgrade-module', {
                            name: 'legacy',
                            project: 'myapp'
                        }, appTree)];
                case 1:
    ...
    it('should add router configuration when --router=true', function () { return __awaiter(_this, void 0, void 0, function () {
        var tree, legacySetup;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_utils_1.runSchematic('upgrade-module', {
                        name: 'legacy',
