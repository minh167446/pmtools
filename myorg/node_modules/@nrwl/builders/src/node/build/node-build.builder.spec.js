                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            jest.mock(core_1.join(core_1.normalize('/root'), 'apps/nodeapp/webpack.config.js'), function () { return mockFunction; }, {
                                virtual: true
                            });
                            return [4 /*yield*/, builder
                                    .run({
                                    root: core_1.normalize('/root'),
                                    sourceRoot: core_1.join(core_1.normalize('/root'), 'apps/nodeapp'),
                                    projectType: 'application',
                                    builder: '@nrwl/builders:node-build',
                                    options: __assign({}, testOptions, { webpackConfig: 'apps/nodeapp/webpack.config.js' })
                                })
                                    .toPromise()];
                        case 1:
                            _a.sent();
