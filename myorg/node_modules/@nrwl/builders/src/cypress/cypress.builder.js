...
var CypressBuilder = /** @class */ (function () {
    ...
    CypressBuilder.prototype.run = function (builderConfig) {
        ...
        return this.compileTypescriptFiles(options.tsConfig, options.watch).pipe(operators_1.tap(function () {
            ...
            return _this.initCypress(options.cypressConfig, options.headless, options.exit, options.record, options.key, options.parallel, options.watch, options.baseUrl, options.browser);
     ...
     * @param isWatching
     */
    CypressBuilder.prototype.initCypress = function (cypressConfig, headless, exit, record, key, parallel, isWatching, baseUrl, browser) {
